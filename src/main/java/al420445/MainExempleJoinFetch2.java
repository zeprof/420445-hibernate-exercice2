...
public class MainExempleJoinFetch2 {
    public static void main(String[] args) throws InterruptedException, SQLException {
        ...
        // Dans cet exemple, on ne fait pas un 'join fetch' ce qui veut dire que
        // la collection de 'passengers' dans Airport.java ne sera pas initialisée
        ...
        final TypedQuery<Airport> airportQuery =
                em.createQuery(qlString2, Airport.class);
        ...
        // Comme la collection n'a pas été initialisée, on aura donc une erreur
